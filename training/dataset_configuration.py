...
from dataloader.mono_datasets import DispDataset
...
# Get Dataset Here
def _prepare_dataset(data_name,
                    datapath=None,
                    trainlist=None,
                    vallist=None,
                    batch_size=1,
...
def prepare_dataset(data_name,
    ...
    print('dataset_name in fn"prepare_dataset" is hard-coded as "vkitti".')

    train_dataset = DispDataset(
        dataset_name = 'VKITTI',
        data_dir = '/data/dataset/VKITTI/vkitti_2.0.3',
        filename_path = 'vkitti_train.txt',
        read_fn = 'read_metric_fixed_focal',
        crop_size = (352, 768),
    )

    test_dataset = DispDataset(
        dataset_name = 'VKITTI',
        data_dir = '/data/dataset/VKITTI/vkitti_2.0.3',
        filename_path = 'vkitti_test.txt',
        read_fn = 'read_metric_fixed_focal',
        crop_size = (352, 768),
    )
    ...
    dataset_config_dict['num_batches_per_epoch'] = num_batches_per_epoch
    dataset_config_dict['img_size'] = (352, 768)
